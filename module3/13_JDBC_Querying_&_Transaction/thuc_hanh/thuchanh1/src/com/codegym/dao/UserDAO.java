...
public class UserDAO implements IUserDAO{
    ...
    private static final String INSERT_USERS_SQL = "INSERT INTO users" + "  (name, email, country) VALUES " +
            " (?, ?, ?);";
    private static final String INSERT_USERS_SQL2 = "INSERT INTO users" + "  (id,name, email, country) VALUES " +
            " (?, ?, ?,?);";
    ...
    public void insertUserStore2() throws SQLException {
        ...
        try (
            ...
            preparedStatement.setString(2, "user.getName(1)");
            preparedStatement.setString(3, "user.getEmail(1)");
            preparedStatement.setString(4, "user.getCountry(1)");
            preparedStatement.executeUpdate();
