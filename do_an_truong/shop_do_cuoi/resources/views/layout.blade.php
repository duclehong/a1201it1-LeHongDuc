                    ...
                    <div class="text-slid-box">
                        <div id="offer-box" class="carouselTicker">
                            <ul class="offer-box">
                                ...
                                <li>
                                    <i class="fab fa-opencart"></i> 10% - 15% off on Fashion
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-widget">
                            <h4>About The Wedding Shop</h4>
                            <p> Công ty phân phối trang phục cưới hàng đầu Việt Nam
                            </p>
                            <ul>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link-contact">
                            ...
                            <ul>
                                <li>
                                    <p><i class="fas fa-map-marker-alt"></i>Address: 97 <br> Đường Ngô Quyền,<br> Đà Nẵng</p>
                                </li>
                                <li>
                                    <p><i class="fas fa-phone-square"></i>Phone: <a href="tel:+1-888705770"> 0387871453</a></p>
                                </li>
                                <li>
                                    <p><i class="fas fa-envelope"></i>Email: <a
                                            href="mailto:contactinfo@gmail.com">theweddingshop@gmail.com</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
