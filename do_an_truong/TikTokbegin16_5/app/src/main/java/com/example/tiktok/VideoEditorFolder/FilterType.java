...
import com.example.tiktok.VideoEditorFolder.filter.GlBitmapOverlaySample;
    ...
    public static GlFilter createGlFilter(FilterType filterType, Context context) {
        switch (filterType) {
            ...
            case LOOK_UP_TABLE_SAMPLE:
                Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.lg);
            ...
            case WATERMARK:
                return new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(), R.drawable.lg), GlWatermarkFilter.Position.RIGHT_BOTTOM);
            case WEAK_PIXEL:
            ...
            case BITMAP_OVERLAY_SAMPLE:
                return new GlBitmapOverlaySample(BitmapFactory.decodeResource(context.getResources(), R.drawable.lg));
            default:
                return new GlFilter();
        }
    }
